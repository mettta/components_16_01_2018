...
;pug_debug_line = 9;pug_debug_filename = "src\u002Fcomponents\u002Fchat\u002Fchat.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = message.text) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
else {
...
pug_html = pug_html + "\n\u003C\u002Ful\u003E";}.call(this,"blockname" in locals_for_with?locals_for_with.blockname:typeof blockname!=="undefined"?blockname:undefined,"messages" in locals_for_with?locals_for_with.messages:typeof messages!=="undefined"?messages:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line, pug_debug_sources[pug_debug_filename]);};return pug_html;}